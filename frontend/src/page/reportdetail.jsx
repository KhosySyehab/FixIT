      ...
      <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            {/* Location */}
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Lokasi</h3>
            ...
            {report.history && report.history.length > 0 && (
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Riwayat Status</h3>
          ...
          <div className="space-y-4">
            ...
            {report.user_id && (
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <p className="text-gray-700">{report.user_id.email}</p>
                  <div className="flex items-center gap-2">
                    <Award className="text-yellow-500" size={18} />
                    <span className="font-semibold text-gray-900">Level {report.user_id.level}</span>
                  </div>
                  <p className="text-gray-600">⭐ {report.user_id.points} points</p>
                </div>
              </div>
            )}
            ...
            <div className="bg-white border-2 border-blue-200 rounded-lg p-4">
              <p className="text-sm text-gray-600 mb-2">Suara Prioritas</p>
              <p className="text-3xl font-bold text-blue-600 mb-4">{report.voteCount || 0}</p>
              <button
                onClick={handleVote}
